class BalancesController < ApplicationController
  ...
  # GET /balances/new
  def new
    @balance = Balance.new(account_id: params[:account_id])
  end
  ...
  def create
    ...
    respond_to do |format|
      if @balance.save
        format.html { redirect_to @balance.account, notice: "Balance was successfully created." }
  ...
  def update
    respond_to do |format|
      if @balance.update(balance_params)
        format.html { redirect_to @balance.account, notice: "Balance was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to accounts_path, status: :see_other, notice: "Balance was successfully destroyed." }
  ...
  private
    ...
    def balance_params
      params.require(:balance).permit(:account_id, :amount, :comment)
    end
end
