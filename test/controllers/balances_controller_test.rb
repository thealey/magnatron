...
class BalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create balance" do
    assert_difference("Balance.count") do
      post balances_url, params: { balance: { account_id: @balance.account_id, amount: @balance.amount, comment: @balance.comment } }
    end
  ...
  test "should update balance" do
    patch balance_url(@balance), params: { balance: { account_id: @balance.account_id, amount: @balance.amount, comment: @balance.comment } }
